...
<head>
    ...
    <title>เช็คเวร นศท.อุบลรัตน์พิทยาคม</title>
...
<body class="p-4">
    ...
    <div class="no-print bg-blue-100 p-4 mb-4 rounded-lg shadow">
        <div class="flex flex-wrap gap-4 justify-between items-center">
            ...
            <div>
                <label class="font-semibold">เลือกวันที่: </label>
        ...
        <div class="mt-4 flex flex-wrap gap-2">
            <span class="font-semibold">ไปที่วัน: </span>
            <button class="day-nav px-3 py-1 bg-blue-200 rounded hover:bg-blue-300" data-day="1">จันทร์</button>
            <button class="day-nav px-3 py-1 bg-blue-200 rounded hover:bg-blue-300" data-day="2">อังคาร</button>
            <button class="day-nav px-3 py-1 bg-blue-200 rounded hover:bg-blue-300" data-day="3">พุธ</button>
            <button class="day-nav px-3 py-1 bg-blue-200 rounded hover:bg-blue-300" data-day="4">พฤหัสบดี</button>
            <button class="day-nav px-3 py-1 bg-blue-200 rounded hover:bg-blue-300" data-day="5">ศุกร์</button>
        </div>
        
        <div class="mt-4 flex gap-2">
            <span class="font-semibold">จุดเวร: </span>
            <button class="gate-nav px-3 py-1 bg-blue-200 rounded hover:bg-blue-300 active" data-gate="1">ประตู 1</button>
            <button class="gate-nav px-3 py-1 bg-blue-200 rounded hover:bg-blue-300" data-gate="2">ประตู 2</button>
        </div>
    ...
    <div id="student-list-modal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 overflow-auto">
        <div class="bg-white max-w-4xl mx-auto my-10 p-6 rounded-lg shadow-xl">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-bold">รายชื่อนักเรียนเวรทั้งหมด</h2>
                <button id="close-student-list" class="text-2xl">&times;</button>
            </div>
            
            <div class="mb-4">
                <div class="flex gap-2 mb-2">
                    <button class="day-filter px-3 py-1 bg-blue-200 rounded hover:bg-blue-300 active" data-day="all">ทั้งหมด</button>
                    <button class="day-filter px-3 py-1 bg-blue-200 rounded hover:bg-blue-300" data-day="1">จันทร์</button>
                    <button class="day-filter px-3 py-1 bg-blue-200 rounded hover:bg-blue-300" data-day="2">อังคาร</button>
                    <button class="day-filter px-3 py-1 bg-blue-200 rounded hover:bg-blue-300" data-day="3">พุธ</button>
                    <button class="day-filter px-3 py-1 bg-blue-200 rounded hover:bg-blue-300" data-day="4">พฤหัสบดี</button>
                    <button class="day-filter px-3 py-1 bg-blue-200 rounded hover:bg-blue-300" data-day="5">ศุกร์</button>
                </div>
            </div>
    ...
    <div id="data-management-modal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 overflow-auto">
        <div class="bg-white max-w-4xl mx-auto my-10 p-6 rounded-lg shadow-xl">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-bold">จัดการข้อมูล</h2>
                <button id="close-data-management" class="text-2xl">&times;</button>
            </div>
            
            <div class="mb-4">
                <p class="text-gray-600">คุณสามารถลบข้อมูลเวรประจำวันที่ต้องการได้ที่นี่</p>
            </div>
    ...
    <script>
        ...
        // Gate names
        const gateNames = ["ประตู 1", "ประตู 2"];
        
        // Duty head names for each day and gate
        const dutyHeads = {
            1: { // Monday
                1: "นศท.ญ.นันท์นภัส พรมวัง",
                2: "นศท.ธนศักดิ์ สาระสิทธิ์"
            },
            2: { // Tuesday
                1: "นศท.ณฐกร กรมดี",
                2: "นศท.ญ.สุชามะรี พลสมบัติ"
            },
            3: { // Wednesday
                1: "นศท.ภัทรพล พิมคำไหล",
                2: "นศท.ศุภฤกษ์ สุโพไข"
            },
            4: { // Thursday
                1: "นศท.ญ.ฟ้ารุ่ง ปั้นชาวนา",
                2: "นศท.นพรัตน์ จันทร์สรณ์"
            },
            5: { // Friday
                1: "นศท.สุรศักดิ์ พิมพ์สมบรูณ์",
                2: "นศท.ปฏิภาณ เขียวนาค"
            }
        };
        ...
        const studentData = {
            1: { // Monday
                1: [ // Gate 1
                    {name: "นศท.พีรวิชญ์ กลิ่นหอม", classYear: "ปี 2"},
                    {name: "นศท.ชัยมงคล มังตา", classYear: "ปี 2"},
                    {name: "นศท.สิทธิกานต์ ไกรยะวงศ์", classYear: "ปี 1"},
                    {name: "นศท.ญ.นันท์นภัส พรมวัง", classYear: "ปี 3"},
                    {name: "นศท.ญ.พัชราพร ฉลี", classYear: "ปี 1"},
                    {name: "นศท.ญ.นลินี น้อยสิม", classYear: "ปี 1"}
                ],
                2: [ // Gate 2
                    {name: "นศท.ธนศักดิ์ สาระสิทธิ์", classYear: "ปี 3"},
                    {name: "นศท.ศุภกร เชื้อบุญมี", classYear: "ปี 2"},
                    {name: "นศท.พชร สุต้น", classYear: "ปี 1"},
                    {name: "นศท.ญ.ณัชชา หลวงอินทร์", classYear: "ปี 1"},
                    {name: "นศท.ญ.อริสรา ภูทองแท้", classYear: "ปี 2"},
                    {name: "นศท.อัจฉริยะ แก้วเกิด", classYear: "ปี 1"}
                ]
            },
            2: { // Tuesday
                1: [ // Gate 1
                    {name: "นศท.จิตติพัฒน์ ชูชนะ", classYear: "ปี 2"},
                    {name: "นศท.ณฐกร กรมดี", classYear: "ปี 2"},
                    {name: "นศท.ชาญยุทธ สีหาบง", classYear: "ปี 3"},
                    {name: "นศท.ภูวดล ข้อยุ่น", classYear: "ปี 1"},
                    {name: "นศท.เมทวัฒน์ ทองโครต", classYear: "ปี 1"},
                    {name: "นศท.ญ.สุกัญญา กองทรัพย์", classYear: "ปี 1"}
                ],
                2: [ // Gate 2
                    {name: "นศท.พัรนัฐ คำบึงกลาง", classYear: "ปี 3"},
                    {name: "นศท.ญ.ขวัญจิรา เฮ้าตุ่น", classYear: "ปี 3"},
                    {name: "นศท.ภีพัตร นพวัฒน์", classYear: "ปี 2"},
                    {name: "นศท.สิทธวีร์ พิมพ์ลี", classYear: "ปี 2"},
                    {name: "นศท.ญ.สุชามะรี พลสมบัติ", classYear: "ปี 2"},
                    {name: "นศท.ชานนท์ โคตะมี", classYear: "ปี 1"},
                    {name: "นศท.วุฒิภัทร มะหันต์", classYear: "ปี 1"}
                ]
            },
            3: { // Wednesday
                1: [ // Gate 1
                    {name: "นศท.ณัฐกรณ์ บุญที", classYear: "ปี 1"},
                    {name: "นศท.ภูพิรัฐ วงษ์ใหญ่", classYear: "ปี 1"},
                    {name: "นศท.ธนกรณ์ ธรรมธร", classYear: "ปี 2"},
                    {name: "นศท.ภัทรพล พิมคำไหล", classYear: "ปี 2"},
                    {name: "นศท.ญ.ธิดารัตน์ วรรณทวี", classYear: "ปี 1"},
                    {name: "นศท.ญ.เปรมมิกา พลซ้าย", classYear: "ปี 2"}
                ],
                2: [ // Gate 2
                    {name: "นศท.ศุภฤกษ์ สุโพไข", classYear: "ปี 2"},
                    {name: "นศท.จีระเดช นันทเพรช", classYear: "ปี 2"},
                    {name: "นศท.ปรินทร์ สุ่มมาตร", classYear: "ปี 1"},
                    {name: "นศท.อภิสิทธิ์ สิมลี", classYear: "ปี 1"},
                    {name: "นศท.อิทธิกร อินทองคำ", classYear: "ปี 2"},
                    {name: "นศท.สุทธิพัทร โตสูงเนิน", classYear: "ปี 3"}
                ]
            },
            4: { // Thursday
                1: [ // Gate 1
                    {name: "นศท.รัฐภูมิ ไชยศรี", classYear: "ปี 2"},
                    {name: "นศท.ฟ้ารุ่ง ปั้นชาวนา", classYear: "ปี 3"},
                    {name: "นศท.เจษฎากร มหาหิงศ์", classYear: "ปี 2"},
                    {name: "นศท.ญ.ศิรพัชศร บุญมี", classYear: "ปี 1"},
                    {name: "นศท.วรเมท ผ่านวงษ์", classYear: "ปี 1"},
                    {name: "นศท.พรมพิริยะ บุรมศรี", classYear: "ปี 1"}
                ],
                2: [ // Gate 2
                    {name: "นศท.นพรัตน์ จันทร์สรณ์", classYear: "ปี 3"},
                    {name: "นศท.ธนากร ชาญประไพ", classYear: "ปี 2"},
                    {name: "นศท.ยุทธพล สุขส่ง", classYear: "ปี 2"},
                    {name: "นศท.ศุภณัฐ จันทลี", classYear: "ปี 2"},
                    {name: "นศท.วีรภัทร แก้วลืมชัย", classYear: "ปี 1"},
                    {name: "นศท.ญ.วิชิดา เชาว์ดี", classYear: "ปี 1"}
                ]
            },
            5: { // Friday
                1: [ // Gate 1
                    {name: "นศท.สิรภพ เค้ามาก", classYear: "ปี 2"},
                    {name: "นศท.วรากร ไชยหานาม", classYear: "ปี 2"},
                    {name: "นศท.สุรศักดิ์ พิมพ์สมบูรณ์", classYear: "ปี 2"},
                    {name: "นศท.ญ.เรืองรำไพ เสริมรัมย์", classYear: "ปี 3"},
                    {name: "นศท.ปกรณ์ ดอกจอก", classYear: "ปี 1"},
                    {name: "นศท.ณัฐชนน อิ่มประไพ", classYear: "ปี 1"}
                ],
                2: [ // Gate 2
                    {name: "นศท.ปฏิภาณ เขียวนาค", classYear: "ปี 3"},
                    {name: "นศท.เปรมสนี ขอฟุ้งกลาง", classYear: "ปี 1"},
                    {name: "นศท.ธีรนัฐ โครตชุม", classYear: "ปี 2"},
                    {name: "นศท.ฉัจรแก้ว พยัคฆเดช", classYear: "ปี 2"},
                    {name: "นศท.เกียรติศักดิ์ กุลทอง", classYear: "ปี 2"},
                    {name: "นศท.สิทศักดิ์ กิติมา", classYear: "ปี 1"}
                ]
            }
        };
        
        // Status types
        const statusTypes = ['มา', 'ลา', 'สาย', 'ขาด'];
        const statusLabels = {
            'มา': '✅ มา',
            'ลา': '📑 ลา',
            'สาย': '⏰ สาย',
        ...
        function calculateStats(dayOfWeek, gateNumber) {
            ...
            if (!attendanceData[key]) {
                return {
                    morning: { มา: 0, ลา: 0, สาย: 0, ขาด: 0, รวม: 0 },
                    evening: { มา: 0, ลา: 0, สาย: 0, ขาด: 0, รวม: 0 },
                    complete: false
                };
            }
                ...
                gateNames.forEach((gateName, gateIndex) => {
                    ...
                    dayGatePage.innerHTML = `
                        ...
                        <div class="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-4">
                            <h1 class="text-2xl font-bold text-center">เช็คเวร นศท.อุบลรัตน์พิทยาคม ปีการศึกษา 2568</h1>
                        ...
                        <div class="p-4">
                            <div class="stats-container">
                                <h3 class="text-lg font-semibold mb-2">สถิติการเข้าเวร</h3>
                                
                                <div class="mb-3">
                                    <h4 class="font-medium">เวรเช้า</h4>
                                    <div class="stats-grid">
                                        <div class="stat-item มา-stat">
                                            <div class="text-lg font-bold">${stats.morning.มา}</div>
                                            <div>✅ มา</div>
                                        </div>
                                        <div class="stat-item ลา-stat">
                                            <div class="text-lg font-bold">${stats.morning.ลา}</div>
                                            <div>📑 ลา</div>
                                        </div>
                                        <div class="stat-item สาย-stat">
                                            <div class="text-lg font-bold">${stats.morning.สาย}</div>
                                            <div>⏰ สาย</div>
                                        </div>
                                        <div class="stat-item ขาด-stat">
                                            <div class="text-lg font-bold">${stats.morning.ขาด}</div>
                                            <div>❌ ขาด</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <h4 class="font-medium">เวรเย็น</h4>
                                    <div class="stats-grid">
                                        <div class="stat-item มา-stat">
                                            <div class="text-lg font-bold">${stats.evening.มา}</div>
                                            <div>✅ มา</div>
                                        </div>
                                        <div class="stat-item ลา-stat">
                                            <div class="text-lg font-bold">${stats.evening.ลา}</div>
                                            <div>📑 ลา</div>
                                        </div>
                                        <div class="stat-item สาย-stat">
                                            <div class="text-lg font-bold">${stats.evening.สาย}</div>
                                            <div>⏰ สาย</div>
                                        </div>
                                        <div class="stat-item ขาด-stat">
                                            <div class="text-lg font-bold">${stats.evening.ขาด}</div>
                                            <div>❌ ขาด</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table class="duty-table w-full text-sm">
                                    <thead>
                                        <tr class="bg-blue-700 text-white">
                                            <th rowspan="3" class="px-2 py-1 text-center" style="width: 5%;">ลำดับ</th>
                                            <th rowspan="3" class="px-2 py-1 text-center name-column">ชื่อ-นามสกุล</th>
                                            <th rowspan="3" class="px-2 py-1 text-center class-column">ชั้น</th>
                                            <th colspan="8" class="px-2 py-1 text-center">การปฏิบัติหน้าที่</th>
                                            <th rowspan="3" class="px-2 py-1 text-center note-column">หมายเหตุ</th>
                                        </tr>
                                        <tr class="bg-blue-600 text-white">
                                            <th colspan="4" class="px-2 py-1 text-center">เวรเช้า</th>
                                            <th colspan="4" class="px-2 py-1 text-center">เวรเย็น</th>
                                        </tr>
                                        <tr class="bg-blue-500 text-white">
                                            <th class="px-2 py-1 text-center bg-green-600 status-column">มา</th>
                                            <th class="px-2 py-1 text-center bg-yellow-600 status-column">ลา</th>
                                            <th class="px-2 py-1 text-center bg-orange-600 status-column">สาย</th>
                                            <th class="px-2 py-1 text-center bg-red-600 status-column">ขาด</th>
                                            <th class="px-2 py-1 text-center bg-green-600 status-column">มา</th>
                                            <th class="px-2 py-1 text-center bg-yellow-600 status-column">ลา</th>
                                            <th class="px-2 py-1 text-center bg-orange-600 status-column">สาย</th>
                                            <th class="px-2 py-1 text-center bg-red-600 status-column">ขาด</th>
                            ...
                            <div class="mt-8 signature-area">
                                ...
                                <div class="text-center">
                                    <div class="mb-16">ลงชื่อ <span class="signature-line">&nbsp;</span></div>
                                    <div>(<span class="signature-line name-field">
                                        <input type="text" class="w-full border-0 bg-transparent focus:outline-none focus:ring-1 focus:ring-blue-500 rounded text-center duty-head-input" placeholder="ชื่อ-นามสกุล..." value="${dutyHead}">
                                    </span>)</div>
                                    <div>หัวหน้าเวร</div>
                                </div>
                                ...
                                <div class="text-center">
                                    <div class="mb-16">ลงชื่อ <span class="signature-line">&nbsp;</span></div>
                                    <div>(<span class="signature-line name-field">
                                        <input type="text" class="w-full border-0 bg-transparent focus:outline-none focus:ring-1 focus:ring-blue-500 rounded text-center teacher-input" value="นาย ณภัทร ชนะโยธา">
                                    </span>)</div>
                                    <div>ครูผู้ตรวจเวร</div>
                                </div>
                            </div>
                        </div>
                    `;
        ...
        function updatePageStatistics(page, dayOfWeek, gateNumber) {
            ...
            if (stats.complete) {
                statusBadge.textContent = 'เช็คครบ';
            ...
            students.forEach((student, index) => {
                ...
                rowsHTML += `
                        <td class="px-2 py-1 note-column">
                            <input type="text" class="w-full border-0 bg-transparent focus:outline-none focus:ring-1 focus:ring-blue-500 rounded name-field" placeholder="หมายเหตุ..." value="${studentAttendance.note || ''}">
                        </td>
                    </tr>
                `;
            });
            ...
            for (let i = 0; i < emptyRowsNeeded; i++) {
                ...
                rowsHTML += `
                    <tr class="${bgClass}" data-row="${rowNum}">
                        <td class="px-2 py-1 text-center">${rowNum}</td>
                        <td class="px-2 py-1 name-column">
                            <input type="text" class="w-full border-0 bg-transparent focus:outline-none focus:ring-1 focus:ring-blue-500 rounded name-field" placeholder="ชื่อ-นามสกุล..." value="${studentAttendance.name || ''}">
                        </td>
                        <td class="px-2 py-1 text-center class-column">
                            <input type="text" class="w-full border-0 bg-transparent focus:outline-none focus:ring-1 focus:ring-blue-500 rounded text-center name-field" placeholder="ชั้น..." style="max-width: 60px;" value="${studentAttendance.classYear || ''}">
                        </td>
                `;
                ...
                for (let gate = 1; gate <= 2; gate++) {
                    ...
                    students.forEach((student, index) => {
                        ...
                        if (studentAttendance.morning && studentAttendance.evening) {
                            if (studentAttendance.morning === 'มา' && studentAttendance.evening === 'มา') {
                                statusText = '✅ มาครบ';
                            } else if (studentAttendance.morning === 'ขาด' || studentAttendance.evening === 'ขาด') {
                                statusText = '❌ ขาด';
                            } else if (studentAttendance.morning === 'สาย' || studentAttendance.evening === 'สาย') {
                                statusText = '⏰ สาย';
                            } else {
                                statusText = '📑 ลา';
                            }
                        } else {
                            statusText = '⚠️ ยังไม่เช็ค';
                        }
        ...
        function generateDataList() {
            ...
            if (Object.keys(attendanceData).length === 0) {
                dataList.innerHTML = '<div class="p-4 text-center text-gray-500">ไม่มีข้อมูลที่บันทึกไว้</div>';
                return;
            }
            ...
            sortedKeys.forEach(key => {
                ...
                item.innerHTML = `
                    <div>
                        <span class="font-semibold">วันที่: ${date}</span>
                        <span class="ml-2">จุดเวร: ${gateNames[gate - 1]}</span>
                        <span class="ml-2 text-sm text-gray-500">(${studentCount} คน)</span>
                    </div>
                    <button class="delete-btn" data-key="${key}">ลบ</button>
                `;
                ...
                deleteBtn.addEventListener('click', function() {
                    ...
                    Swal.fire({
                        ...
                        text: `คุณต้องการลบข้อมูลวันที่ ${date} จุดเวร ${gateNames[gate - 1]} ใช่หรือไม่?`,
                        icon: 'warning',
        ...
        function saveDataToGoogleSheets() {
            ...
            if (!saveToLocalStorage()) {
                Swal.fire({
                    icon: 'error',
                    title: 'ไม่สามารถบันทึกข้อมูลในเบราว์เซอร์ได้',
                    text: 'อาจเกิดจากพื้นที่เก็บข้อมูลเต็ม หรือเบราว์เซอร์ไม่อนุญาตให้เก็บข้อมูล',
                    confirmButtonText: 'ตกลง'
                });
                return;
            }
            ...
            sendToGoogleSheets(dataToSend)
                ...
                .catch(error => {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'ไม่สามารถบันทึกข้อมูลใน Google Sheets ได้',
                        text: 'เกิดข้อผิดพลาดในการเชื่อมต่อกับ Google Sheets แต่ข้อมูลยังถูกบันทึกในเบราว์เซอร์',
                        confirmButtonText: 'ตกลง'
                    });
                });
        }
        ...
        document.getElementById('date-picker').addEventListener('change', (e) => {
            ...
            if (day === 0 || day === 6) {
                Swal.fire({
                    icon: 'warning',
                    title: 'วันไม่ถูกต้อง',
                    text: 'กรุณาเลือกวันจันทร์ถึงศุกร์เท่านั้น',
                    confirmButtonText: 'ตกลง'
                });
                return;
            }
        ...
        document.getElementById('delete-all-data').addEventListener('click', () => {
            Swal.fire({
                ...
                text: 'คุณต้องการลบข้อมูลทั้งหมดใช่หรือไม่? การกระทำนี้ไม่สามารถย้อนกลับได้',
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#d33',
                cancelButtonColor: '#3085d6',
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        ...
                        text: 'ข้อมูลทั้งหมดถูกลบออกจากระบบเรียบร้อยแล้ว',
                        confirmButtonText: 'ตกลง'
                    });
                }
            });
